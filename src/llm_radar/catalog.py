...
WATCHED_HF_ORGS = (
    ...
    "MiniMaxAI",
    "nvidia",
    # Verified, well-known model-publishing orgs not previously watched -
    # each already has a handful of models in the catalog via aggregators,
    # confirming these are real, distinct publishers worth watching directly
    # for their full HF catalog rather than only sampling through resellers.
    "allenai",
    "microsoft",
    "ibm-granite",
    "CohereForAI",
